-- Fix: Allow checked_in -> in_consultation transition
-- The startConsultationAction accepts both "waiting" and "checked_in" patients,
-- but the validate_appointment_status trigger only allowed "waiting -> in_consultation".
-- A dentist can start consultation directly with a checked-in patient.
